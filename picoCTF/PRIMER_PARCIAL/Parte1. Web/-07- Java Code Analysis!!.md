...
#### Solucion
ESTE RETO ES PARECIDO A UNO QUE NO PUDE REALIZAR N UNA CTIVIDAD PASADA YA QUE AL MOMENTO DE QUERER CAMBIAR DATOS (en la pagina de https://jwt.io/) EN LA PARTE DE **Decoded Payload** Y **Valid secret** no me deja editar, no me da la opción de borrar, por ende no puedo actualizar el **JWT** y no puedo concluir el reto. 