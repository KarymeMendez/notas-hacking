...
#### Solucion
1. ```wget https://jupiter.challenges.picoctf.org/static/14393e18d98fedbaedbc28896d7ef31a/message.wav```
2. ```cd /opt```
3. ``sudo git clone https://github.com/colaclanth/sstv.git   ``
...
Tenemos la bandera --->   picoCTF{beep_boop_im_in_space}